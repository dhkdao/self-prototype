...
import { Button, Field, Input, Dialog, DialogPanel, DialogTitle } from '@headlessui/react';
...
function VerificationComponent() {
  ...
  return (
    ...
    <div className="verification-container flex flex-col items-center">
      ...
      { account.address && <section className="flex flex-col items-center my-4">
    ...
    >
      <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
        <div className="flex min-h-full items-center justify-center p-4">
          ...
          >
            <DialogTitle as="h2" className="text-base/8 font-medium text-black text-center">
              Scan Self QR Code
            </DialogTitle>
